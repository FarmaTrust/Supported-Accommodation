...
final class RouterRegistrar
{
    ...
    private const ROUTERS = [
        ...
        Routers\AssuranceRouter::class,
        Routers\AuthRouter::class,
        Routers\CareRouter::class,
        Routers\ColleagueInvitationsRouter::class,
        Routers\ComplianceHubRouter::class,
        ...
        Routers\Regulation28Router::class,
        Routers\RoleManagementRouter::class,
